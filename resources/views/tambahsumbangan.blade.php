                  ...
                  <div class="card-body" style="background-color:white">
                    <form method="post" action="/postdatacharity">
                      ...
                      <div class="pl-lg-4">
                        <div class="row">
                          <div class="col-lg-12">
                            <?php foreach($dati as $dst){
                              $jumlah = $dst->jumlah_donasi;
                            }
                            ?>
                            <?php foreach($data as $dt){ ?>
                            <div class="form-group focused">
                              <input type="hidden" name="barang" value="{{ $dt->id }}">
                              <b><label class="form-control-label" for="input-username">Nama Donasi</label></b><br>
                              <label class="form-control-label" for="input-username">{{ $dt->nama_donasi }}</label>
                            </div>
                            <div class="form-group focused">
                              <b><label class="form-control-label" for="input-username">Deskripsi</label></b><br>
                              <label class="form-control-label" for="input-username">{{ $dt->deskripsi }}</label>
                            </div>
                          <?php } ?>
                          </div>
                        </div>
                      ...
                      <div class="pl-lg-4">
                        ...
                        <?php }else{ ?>
                            <div class="form-group focused">
                            <center><p style="color:red">Mohon maaf, anda belum dapat melakukan donasi. Silakan Melakukan donasi barang terlebih dahulu</p></center>
                            </div>
                        <?php } ?>
                        </div>
                        </div>
