          ...
          <div class="content-wrapper">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <?php foreach ($data as $d) { ?>
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Nama Pengaju</label>
                          <div class="col-sm-10">
                            <p>{{$name}}</p>
                          </div>
                        </div>
            ...
            <div class="col-xxl" style="margin-top:30px">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="post" action="/verificator/prosesverifikasipembelian">
                    @csrf
                  ...
                  <input type="hidden" class="form-control" id="basic-default-name" name="id_pengajuan" value="<?php echo $gas?>" />
                    <div class="row mb-3">
