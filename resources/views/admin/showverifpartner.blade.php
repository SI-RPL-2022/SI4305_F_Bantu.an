        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Form Verifikasi Pengajuan Pembelian</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <?php foreach ($data as $d) {
                        ...
                        ?>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Nama Donasi</label>
                          <div class="col-sm-10">
                            <p>{{$d->nama_donasi}}</p>
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-email">Mitra</label>
                          <div class="col-sm-10">
                                <p>{{$d->mitra}}</p>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-phone">Dokumen</label>
                          <div class="col-sm-10">
                              <a href="/assets/dokumen/{{$d->dokumen}}">Dokumen</a>
                          </div>
                        </div>
                    </div>
                  </div>
            ...
            <div class="col-xxl" style="margin-top:30px">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="post" action="/admin/prosesverifikasipartner">
                    @csrf
                  <input type="hidden" class="form-control" id="basic-default-name" name="id" value="<?php echo $id?>" />
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      <label class="col-sm-2 col-form-label" for="basic-default-name">Status Penerimaan</label>
                      <div class="col-sm-10">
